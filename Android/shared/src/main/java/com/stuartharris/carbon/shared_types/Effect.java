...
public abstract class Effect {
    ...
    public static Effect deserialize(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
        ...
        switch (index) {
            ...
            case 1: return GetLocation.load(deserializer);
            case 2: return Render.load(deserializer);
            case 3: return Time.load(deserializer);
    ...
    public static final class GetLocation extends Effect {
        public final LocationRequest value;

        public GetLocation(LocationRequest value) {
            java.util.Objects.requireNonNull(value, "value must not be null");
            this.value = value;
        }
        ...
        static GetLocation load(com.novi.serde.Deserializer deserializer) throws com.novi.serde.DeserializationError {
            deserializer.increase_container_depth();
            Builder builder = new Builder();
            builder.value = LocationRequest.deserialize(deserializer);
            deserializer.decrease_container_depth();
            return builder.build();
        }
